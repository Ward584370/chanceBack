...
Route::get('images/getFactoryImages/{factoryId}', [OpprtunityImagesController::class, 'getFactoryImages']);
...
Route::get('/test-distribute-returns', function () {
    $job = new \App\Jobs\DistributeReturnsJob();
    $job->handle(); // نفذ الوظيفة مباشرة
    return response()->json(['message' => 'Job executed']);
});
